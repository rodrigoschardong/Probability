...
class Tests(unittest.TestCase):
    ...
    def test_Experiment_zero(self):
        self.assertEqual(len(Probability_F.Experiment(Probability_F, 0, 0)),  0, "Should be 0")
    def test_Experiment_five(self):
        self.assertEqual(len(Probability_F.Experiment(Probability_F, 0, 5)),  5, "Should be 5")
    def test_Experiment_hundred(self):
        self.assertEqual(len(Probability_F.Experiment(Probability_F, 0, 100)),  100, "Should be 100")
    def test_Experiment_negative(self):
        self.assertEqual(len(Probability_F.Experiment(Probability_F, 0, -1)),  0, "Should be 0")
    def test_Experiment_broken_num(self):
        self.assertEqual(len(Probability_F.Experiment(Probability_F, 0, 2.5)),  2, "Should be 2")
    def test_Experiment_negative_broken_num(self):
        self.assertEqual(len(Probability_F.Experiment(Probability_F, 0, -2.5)),  0, "Should be 0")
